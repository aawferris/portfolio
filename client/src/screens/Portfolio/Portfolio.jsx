      ...
      <div className="flip-card">
        <div className="flip-card-inner">
          ...
          <div className="flip-card-back">
            ...
            <a className="project-link" href="https://86list.netlify.app/" alt="deployed app" target="_blank" rel="noreferrer">Site</a>
            <a className="project-link" href="https://github.com/aawferris/86list" alt="Git Hub repo" target="_blank" rel="noreferrer">Repo</a>
          </div>
        </div>
        <div>
        </div>
        ...
        <div className="flip-card-inner">
          ...
          <div className="flip-card-back">
            ...
            and React.js to create a dashboard for teachers to upload and share lesson planning resources.  The Team
              ...
              <a className="project-link" href="https://teacher-source.netlify.app/" alt="deployed app" target="_blank" rel="noreferrer">Site</a>
              <a className="project-link" href="https://github.com/aawferris/teachersource" alt="Git Hub repo" target="_blank" rel="noreferrer">Repo</a>
          </div>
        </div>
      </div>
      <div className="flip-card">
        <div className="flip-card-inner">
          ...
          <div className="flip-card-back">
            ...
            get work done.  This app has a place for note-taking and task lists.  I want to make this app
              ...
              <a className="project-link" href="https://productively.netlify.app/" alt="deployed app" target="_blank" rel="noreferrer">Site</a>
              <a className="project-link" href="https://github.com/aawferris/productive.ly" alt="Git Hub repo" target="_blank" rel="noreferrer">Repo</a>
          </div>
        </div>
      </div>
      <div className="flip-card">
        <div className="flip-card-inner">
          ...
          <div className="flip-card-back">
            ...
            axios calls to RESTFUL APIs to to create this silly random person generator, styled to be a 
              ...
              <a className="project-link" href="https://aawferris.github.io/CIA-cover-story/index.html" alt="deployed app" target="_blank" rel="noreferrer">Site</a>
              <a className="project-link" href="https://github.com/aawferris/CIA-cover-story" alt="Git Hub repo" target="_blank" rel="noreferrer">Repo</a>
          </div>
        </div>
      </div>
    </div>
